...
def AddMusic():
    ...
    if path:
       os.chdir(path)
       songs = os.listdir(r'C:\Users\YUVA\Desktop\music')
...
image_icon = PhotoImage(file=r"C:\Users\YUVA\Downloads\logo png.png")
root.iconphoto(False, image_icon)


frameCnt = 30
frames = [PhotoImage(file=r'C:\Users\YUVA\Downloads\aa1.gif',format = 'gif -index %i' %(i)) for i in range(frameCnt)]
